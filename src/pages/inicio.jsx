...
export default function Inicio() {
  ...
  const beneficiosPopups = [
    ...
    },
    {
      ...
      fullContent: "Com a eficiência energética, através da utilização de fontes renováveis e da otimização de processos industriais, você obterá economias significativas em custos operacionais. Mesmo para a sua casa, com o uso da energia fotovoltaica, a dependência da energia da rede será menor, diminuindo o valor da conta de luz."
    },
    {
      title: "Para o Seu Conhecimento",
      initialContent: "Sustentabilidade é o que se mais ouve falar atualmente...",
      fullContent: "Sustentabilidade é o que mais se ouve falar atualmente, e para ajudar o meio ambiente, é essencial que o conhecimento seja acessível a todos. O Brasil conta com 27 empresas no ranking de sustentabilidade anual e 8 das maiores empresas sustentáveis do mundo. Não perca a oportunidade de entrar nessa onda sustentável; em nosso site, você encontra o conhecimento necessário para ir além."
    },
    {
    ...
    },
    {
      ...
      fullContent: "Investir no uso de energia renovável em sua casa vai muito além de diminuir gastos e, sim, priorizar um presente e um futuro melhor para as pessoas de sua família, visando alcançar uma excelente qualidade de vida."
    },
  ];
  ...
  function MudarParagrafo1() {
    setParagrafos([
      ...
      "Nós focamos em abrir portas para que todos possam ter acesso a informações sustentáveis sobre as quais muitos nunca ouviram falar, para ajudar tanto o planeta quanto a vida de quem necessita.",
